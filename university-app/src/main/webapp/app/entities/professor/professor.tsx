  ...
  return (
    <div>
      <h2 id="professor-heading" data-cy="ProfessorHeading">
        <Translate contentKey="universityApp.professor.home.title">Professors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="universityApp.professor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/professor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="universityApp.professor.home.createLabel">Create new Professor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {professorList && professorList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="universityApp.professor.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="universityApp.professor.home.notFound">No Professors found</Translate>
            </div>
          )
        )}
      </div>
