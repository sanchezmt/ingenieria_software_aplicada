  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="universityApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            <Translate contentKey="universityApp.student.home.createOrEditLabel">Create or edit a Student</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('universityApp.student.firstName')}
              ...
              />
              <ValidatedField
                label={translate('universityApp.student.lastName')}
                id="student-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('universityApp.student.email')}
                id="student-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('universityApp.student.enrollmentDate')}
