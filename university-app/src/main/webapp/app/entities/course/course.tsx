  ...
  return (
    <div>
      <h2 id="course-heading" data-cy="CourseHeading">
        <Translate contentKey="universityApp.course.home.title">Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="universityApp.course.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/course/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="universityApp.course.home.createLabel">Create new Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseList && courseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="universityApp.course.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('credits')}>
                  <Translate contentKey="universityApp.course.credits">Credits</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('credits')} />
                </th>
                <th>
                  <Translate contentKey="universityApp.course.professor">Professor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {courseList.map((course, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{course.professor ? <Link to={`/professor/${course.professor.id}`}>{course.professor.firstName}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="universityApp.course.home.notFound">No Courses found</Translate>
            </div>
          )
        )}
      </div>
